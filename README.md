# Hi, I'm Amirreza Arefi 👋

I'm a **Computer Science graduate from San José State University** interested in building practical software across web, mobile, backend, and cloud systems.

I'm currently looking for **New Grad / Entry-Level Software Engineering opportunities** where I can contribute, keep learning, and build products that solve real problems.
...
- 🔎 Open to New Grad and Entry-Level Software Engineering opportunities
...
- Integrated parking occupancy, VTA transit data, and Mapbox routing
- Designed a weighted scoring algorithm to recommend commute options based on time, cost, parking, and route conditions
...
- Built product lookup and waste-classification workflows
...
- Built account, review, interaction, and moderation features
...
- Estimates password strength and cracking difficulty
...
- Designed reusable Java classes using object-oriented principles
...
⭐ Always interested in learning new technologies, collaborating on interesting projects, and building software that people can actually use.
